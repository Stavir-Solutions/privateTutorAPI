...
router.post('/teachers', async (req, res) => {
    ...
    buildSuccessResponse(res, 200, {
        ...
        refreshToken: await generateRefreshToken(buildTeacherRefreshTokenPayload(teacherId))
    });
...
router.post('/students', async (req, res) => {
    ...
    buildSuccessResponse(res, 200, {
        ...
        refreshToken: await generateRefreshToken(buildStudentRefreshTokenPayload(studentId))
    });
